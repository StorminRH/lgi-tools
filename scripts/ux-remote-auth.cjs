...
async function installOriginScopedBypass(context, targetOrigin, secret) {
...
async function loadRemoteAuthOptions({ storageState = null, cookieJar = null } = {}) {
  ensureBypassSecretFromEnvLocal();
  return {
...
module.exports = { installOriginScopedBypass, loadRemoteAuthOptions };
