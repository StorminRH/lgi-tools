...
The program runs `plugins/pstack-cursor/skills/poteto-mode/playbooks/<execution playbook>.md`. <Who merges, and which PR ids are the operator's items that stop at merge-ready.>
...
- [ ] Read these from trunk at program start. Re-read them at every tick.
  - [ ] `git show origin/development:plugins/pstack-cursor/skills/poteto-mode/playbooks/<execution playbook>.md`
  - [ ] `git show origin/development:plugins/pstack-cursor/skills/swarm/SKILL.md`
  - [ ] `git show origin/development:<control skill path>`
  - [ ] `git show origin/development:plugins/pstack-cursor/skills/poteto-mode/playbooks/opening-a-pr.md`
  - [ ] `git show origin/development:plugins/pstack-cursor/skills/<each other leaf skill the program uses>`
...
- [ ] Follow this dependency graph. Start dependent work only after its parent merges, or base it on the parent branch when the execution playbook stacks.
  - [ ] <PR id> and <PR id> are independent and first. Both branch from `development`.
  - [ ] <PR id> after <PR id>.
...
- [ ] Use GitHub for every PR operation. Linear owns the plan and handoff.
- [ ] Open the PR as a draft with `gh pr create --draft --base <base-branch>` on GitHub. A stack child targets its parent branch.
...
- [ ] At the merge-ready head SHA, run the swarm per `plugins/pstack-cursor/skills/swarm/SKILL.md`. One gates lane. The ten live lanes from the PR's **Verify, live** block. The perf lane from its **Verify, perf** block. One audit lane that reads the diff and the receipts and distrusts the PR body.
...
**Verify, live.** Tests alone are not sufficient verification. A PR is verified only when its unit, live, and perf boxes are all checked. Ten lanes using the configured `swarm workers` model at the PR head, per the boot recipe.
...
<Docs to read before editing. Which PRs get `plugins/pstack-cursor/skills/how/SKILL.md` and `plugins/pstack-cursor/skills/interrogate/SKILL.md`. The trail per `plugins/pstack-cursor/skills/show-me-your-work/SKILL.md`.>
````
