...
The program runs `plugins/pstack-codex/skills/poteto-mode/playbooks/<execution playbook>.md`. <Who merges, and which PR ids are the operator's items that stop at merge-ready.>
...
- [ ] Read these from trunk at program start. Re-read them at every tick.
  - [ ] `git show origin/development:plugins/pstack-codex/skills/poteto-mode/playbooks/<execution playbook>.md`
  - [ ] `git show origin/development:plugins/pstack-codex/skills/swarm/SKILL.md`
  - [ ] `git show origin/development:<control skill path>`
  - [ ] `git show origin/development:plugins/pstack-codex/skills/poteto-mode/playbooks/opening-a-pr.md`
  - [ ] `git show origin/development:plugins/pstack-codex/skills/<each other leaf skill the program uses>`
...
- [ ] At the merge-ready head SHA, run the swarm per `plugins/pstack-codex/skills/swarm/SKILL.md`. One gates lane. The ten live lanes from the PR's **Verify, live** block. The perf lane from its **Verify, perf** block. One audit lane that reads the diff and the receipts and distrusts the PR body.
...
**Verify, live.** Tests alone are not sufficient verification. A PR is verified only when its unit, live, and perf boxes are all checked. Ten lanes on `gpt-5.6-sol` at the PR head, per the boot recipe.
...
<Docs to read before editing. Which PRs get `plugins/pstack-codex/skills/how/SKILL.md` and `plugins/pstack-codex/skills/interrogate/SKILL.md`. The trail per `plugins/pstack-codex/skills/show-me-your-work/SKILL.md`.>
````
