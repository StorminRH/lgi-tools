...
Use the active workspace transcript or export explicitly exposed by this Codex session. If none is available, report the gap and use the conversation digest, GitHub and Linear evidence as described in HARNESS.md.
