...
description: Thermo-nuclear code quality audit (maintainability, structure, 1k-line rule, spaghetti, code-judo). Invoked via Task with a change number. Runs gh pr diff. Loads rubric from the local thermo-nuclear-code-quality-review skill.
---
