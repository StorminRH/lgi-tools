...
- `model`: your configured why-investigators model (default `cursor-grok-4.6-xhigh-fast`)
...
- `subagent_type`: `generalPurpose`
- `model`: your configured why-synthesizer model (default `claude-fable-5-thinking-high`)
