...
6. Run `node .cursor/skills/poteto-mode/scripts/check-plan.mjs <plan.md>` and fix every line it prints (the **encode-lessons-in-structure** principle skill).
...
The program runs `.cursor/skills/poteto-mode/playbooks/<execution playbook>.md`. <Who merges, and which PR ids are the operator's items that stop at merge-ready.>
...
- [ ] Read these from trunk at program start. Re-read them at every tick.
  - [ ] `git show origin/development:.cursor/skills/poteto-mode/playbooks/<execution playbook>.md`
  - [ ] `git show origin/development:.cursor/skills/swarm/SKILL.md`
  - [ ] `git show origin/development:<control skill path>`
  - [ ] `git show origin/development:.cursor/skills/poteto-mode/playbooks/opening-a-pr.md`
  - [ ] `git show origin/development:.cursor/skills/<each other leaf skill the program uses>`
...
- [ ] At the merge-ready head SHA, run the swarm per `.cursor/skills/swarm/SKILL.md`. One gates lane. The ten live lanes from the PR's **Verify, live** block. The perf lane from its **Verify, perf** block. One audit lane that reads the diff and the receipts and distrusts the PR body.
...
<Docs to read before editing. Which PRs get `.cursor/skills/how/SKILL.md` and `.cursor/skills/interrogate/SKILL.md`. The trail per `.cursor/skills/show-me-your-work/SKILL.md`.>
````
