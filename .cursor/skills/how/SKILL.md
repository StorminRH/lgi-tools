...
- `model`: your configured how-explorer model (default `cursor-grok-4.6-xhigh-fast`)
- `readonly`: `true`
...
After the explanation is complete, spawn one architectural critic per model in your configured how-critics list (defaults `claude-fable-5-thinking-high`, `gpt-5.6-sol-high`, `cursor-grok-4.6-xhigh-fast`, `kimi-k3-max`), all in a single message.
