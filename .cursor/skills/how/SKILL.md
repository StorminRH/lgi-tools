...
- `model`: your configured how-explorer model (default `cursor-grok-4.6-high-fast`)
- `readonly`: `true`
...
- `subagent_type`: `generalPurpose`
- `model`: your configured how-explainer model (default `claude-fable-5-thinking-high`)
- `readonly`: `true`
...
After the explanation is complete, spawn one architectural critic per model in your configured how-critics list (defaults `claude-fable-5-thinking-high`, `gpt-5.6-sol-medium`, `cursor-grok-4.6-high-fast`, `glm-5.2-high`), all in a single message.
