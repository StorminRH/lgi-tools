export default {
  name: 'templates-menu',
  get route() { return '/industry/692'; },
  viewports: ['desktop'],
  async run({ page, baseUrl, check, diagnostics }) {
    diagnostics.expectHttp({ pathname: '/api/account/saved-plans', method: 'POST', status: 401 });
    ...
    await notFoundToast.waitFor({ timeout: 12000 });
