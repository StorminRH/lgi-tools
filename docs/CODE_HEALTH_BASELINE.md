...
| --- | ---: | ---: | --- |
| Production TS/TSX files | 762 | 761 | +1 at 3.9.4.1 for the migration-URL resolver seam; recount 762 at 3.9.4.1 close-out |
| Production TS/TSX LOC | 73,064 | 73,037 | +27 at 3.9.4.1 for the `resolveMigrationUrl` seam and the migrate.ts wiring; recount 73,064 at 3.9.4.1 close-out |
| Test files | 363 | 362 | +1 at 3.9.4.1 (migrate-url unit suite); recount 363 at 3.9.4.1 close-out |
