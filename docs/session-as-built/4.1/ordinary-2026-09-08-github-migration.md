...
- [LGI-119-github-guidance] Changed: Existing Codex and Cursor skills, agent definitions and process documentation retain their original wording and behavior, with direct GitHub forge and Actions command updates. Broad guidance rewrites were reverted before acceptance; original descriptions, native model pins, review rubrics and local test requirements are preserved.
