...
export const modules = import.meta.glob([
  ...
  '../lib/mapAccess.ts',
  '../lib/mapAuthoringCollapse.ts',
  '../lib/mapAuthoringEvents.ts',
  '../lib/mapAuthoringFields.ts',
  '../lib/mapAuthoringHome.ts',
  '../lib/mapAuthoringSweep.ts',
  '../lib/mapAuthoringTombstone.ts',
