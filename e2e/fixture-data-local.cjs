...
function requireLocalUrl(value, label, protocols = ['http:', 'https:']) {
  let url;
...
function requireLocalAuthEnvironment(baseURL, env = process.env) {
...
function requireLocalConvexEnvironment(env = process.env) {
