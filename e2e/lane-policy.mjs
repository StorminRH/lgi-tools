...
export const lanes = ['mandatory-production', 'local-mutation', 'deployed-readonly', 'dev-only', 'benchmark'];

/** @param {{env?: Record<string, string | undefined>, argv?: string[]}} options */
export function resolveLane({ env = process.env, argv = [] } = {}) {
...
export function selectJourneys({ journeys, lane, scenarioIds, list = false }) {
