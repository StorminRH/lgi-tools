...
Examples:
  python3 tools/cli.py delivery github-api GET /repos/OWNER/REPO/pulls/123
  python3 tools/cli.py delivery github-api POST /repos/OWNER/REPO/pulls \
    --field title='My PR' --field head=branch --field base=main --body-file pr.md
  python3 tools/cli.py delivery github-api GET /repos/OWNER/REPO/issues/123/comments --paginate
