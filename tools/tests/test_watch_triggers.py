...
from tools.quality.check_watch_triggers import _measure, collect_findings
from tools.quality.repo_measures import MeasureError
...
class WatchTriggerTests(unittest.TestCase):
    ...
    def test_absent_clone_group_measures_zero(self) -> None:
        ...
        with patch("tools.quality.check_watch_triggers.clone_file_counts", return_value={}):
            self.assertEqual(
                [
    ...
    def test_check_exit_code_blocks_errors_but_not_promotions(self) -> None:
        ...
        promoted = subprocess.run(
            [
                sys.executable,
                "-m",
                "tools.quality.check_watch_triggers",
                "--root",
