...
//
// CALIBRATION KNOBS (provisional — tuned against live data at the UX gate):
...
export const SCORE_ADV_WINDOW_DAYS = 30;
...
export const SELL_WALL_BAND_PCT = 5;
...
// PROVISIONAL.
export const INSTANT_DUMP_BAND_PCT = 2;
