...
function LegalCard({
  ...
  return (
    <section className={cn(cardSurface, 'reveal px-5 py-6 sm:px-8 sm:py-7', reveal)}>
      <h2 className="mb-6 font-display text-h3 font-bold uppercase leading-none tracking-optical text-name">
        {title}
      </h2>
      {children}
    </section>
    ...
    <PageShell mode="reading">
      ...
      <div className="pb-16">
        <Prose className="flex flex-col gap-6">
          <LegalCard title="Site Usage" reveal="reveal-1">
            ...
            <LegalSection label="Performance & rate limiting">
              <p>
                ...
                <ExternalLink href="https://upstash.com">Upstash Redis</ExternalLink>{' '}
          ...
          <LegalCard title="EVE Data" reveal="reveal-2">
            <p className="mb-7">
            ...
            <LegalSection label="What signing in shares">
              <p>
                ...
                <strong>
                  <ExternalLink href="https://developers.eveonline.com/docs/services/sso/">EVE SSO</ExternalLink>
                </strong>
            ...
            <LegalSection label="Character transfer detection">
              <p>
                ...
                <ExternalLink href="https://forums.eveonline.com/c/marketplace/character-bazaar/60">Character Bazaar</ExternalLink>
            ...
            <LegalSection label="Community data credits">
              <p>
                ...
                <ExternalLink href="https://anoik.is">anoik.is</ExternalLink>
                . Before a snapshot can be promoted, LGI.tools cross-checks it
                against the MIT-licensed Pathfinder lineage data published by{' '}
                <ExternalLink href="https://github.com/exodus4d/pathfinder">exodus4d</ExternalLink>
                .
              </p>
            </LegalSection>
          </LegalCard>

          <LegalCard title="Our Privacy Stance" reveal="reveal-3">
            ...
            <LegalSection label="What we never do">
              <p>
                ...
                <ExternalLink href="https://developers.eveonline.com/docs/services/esi/overview/">EVE&apos;s official APIs</ExternalLink>{' '}
            ...
            <LegalSection label="Open-source licensing">
              <p>
                ...
                <ExternalLink href="https://github.com/StorminRH/lgi-tools/blob/main/LICENSE">MIT License</ExternalLink>
                , with full source at{' '}
                <ExternalLink href="https://github.com/StorminRH/lgi-tools">github.com/StorminRH/lgi-tools</ExternalLink>
