...
/**
 * Site-group error boundary. Catches any unhandled error thrown rendering a
 * (site) page (Server or Client Component) and shows a friendly EVE-themed
 * fallback. The root <html>/<body> and the (site) layout's header and footer
 * keep rendering — only the page body is replaced. global-error.tsx would be
