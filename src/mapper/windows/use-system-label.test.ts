...
describe('useSystemLabel', () => {
  it('names any directory system, including k-space that is not a map node', () => {
    assets.systemInfo.mockImplementation((id) => {
      if (id === JITA) {
        return { id: JITA, name: 'Jita', regionName: 'The Forge', whClassId: null, security: 0.946, effect: null };
      }
      if (id === HOLE) {
        return { id: HOLE, name: 'J123456', regionName: 'Test Region', whClassId: 5, security: -1, effect: null };
      }
      return null;
    });
