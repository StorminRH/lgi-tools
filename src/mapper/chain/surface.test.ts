...
describe('mapper source contract', () => {
  ...
  it('walks the whole mapper zone', () => {
    expect(mapperFiles().toSorted()).toEqual([
      ...
      'canvas/SystemIntelMarks.tsx',
      'canvas/SystemNode.tsx',
      'canvas/camera-follow-model.ts',
      'canvas/disc-chrome.ts',
      'canvas/edge-geometry.ts',
      'canvas/edge-menu.ts',
      'canvas/map-controls-model.ts',
      'canvas/node-chrome.ts',
      'canvas/use-camera-follow.ts',
      'canvas/wormhole/WormholeVisual.tsx',
      'canvas/wormhole/host.ts',
      'canvas/wormhole/motion.ts',
      'canvas/wormhole/painter.ts',
      'canvas/wormhole/palette.ts',
      'canvas/wormhole/shaders.ts',
      'chain/ChainHost.tsx',
      'chain/ChainLive.tsx',
