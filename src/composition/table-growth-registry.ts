...
export const TABLE_GROWTH_STORIES = [
  ...
  },
  {
    ...
    prunedBy:
      'daily /api/cron/refresh-gsc housekeeping, preserving pending and currently promoted snapshots',
  },
  ...
  },
  {
    ...
    reason: 'one promoted row per finite EVE system and wormhole code pair',
  },
