...
export const TABLE_GROWTH_STORIES = [
  ...
  },
  {
    ...
    prunedBy:
      'daily /api/cron/refresh-gsc housekeeping via pruneWhStaticsSnapshots, preserving pending and currently promoted',
  },
  ...
  },
  {
    ...
    reason:
      'replace-all promoted community statics copy; one row per known (system, code) pair',
  },
