...
// Domain-agnostic: it knows a type id + a variant, nothing about blueprints
// or prices. A plain <img> by design — the image host is already allowed by
// `img-src`, so this never touches next/image (no optimizer, no
// `remotePatterns`, no optimization billing or abuse vector). On a 404 it
// swaps to a tone-styled monogram rather than leaving a broken-image element.
