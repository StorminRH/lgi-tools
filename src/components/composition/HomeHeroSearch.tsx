...
import { floatSurface, surfaceGlowHover } from '@/components/ui/card';
  ...
  return (
    <Button
      ...
      className={cn(
        floatSurface,
        surfaceGlowHover,
        'reveal reveal-4 group w-full max-w-[620px] cursor-text gap-3 rounded-sheet py-2 pr-2 pl-5 text-left',
      )}
    >
