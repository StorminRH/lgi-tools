...
/**
 * The 404 body copy shared by the root unmatched-URL page and the (site)
 * segment not-found file. Carries no chrome of its own — each caller supplies
 * exactly one site-chrome layer.
 */
