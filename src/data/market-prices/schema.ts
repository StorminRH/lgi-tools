...
// (10000002) in phase 2 — see PHASE_2_PLAN.md. No FK to eve_types:
// this slice operates in pure number space and must not depend on
// the eve-data slice's schema being populated first.
//
