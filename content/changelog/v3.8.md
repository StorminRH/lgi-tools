...
#### Fixed
- Missing wormhole-site pages now establish their noindex 404 while page metadata loads, preventing the browser recovery errors seen on invalid site addresses.
