...
description: >-
  ...
  start-session finds that the current session has no approved plan.
---
...
5. Present the plan and wait for Ryan's approval. Do not persist it in Plan
   mode.
6. After approval in execution mode, write the deterministic
