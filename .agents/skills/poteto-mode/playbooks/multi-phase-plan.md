...
- [ ] Read these from trunk at program start. Re-read them at every tick.
  - [ ] `git show origin/development:.agents/skills/poteto-mode/playbooks/<execution playbook>.md`
  - [ ] `git show origin/development:.agents/skills/swarm/SKILL.md`
  - [ ] `git show origin/development:<control skill path>`
  - [ ] `git show origin/development:.agents/skills/poteto-mode/playbooks/opening-a-pr.md`
  - [ ] `git show origin/development:.agents/skills/<each other leaf skill the program uses>`
